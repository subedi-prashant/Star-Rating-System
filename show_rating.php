...
<div class="container">		
	<h2>Restro Star Rating System with Ajax, PHP and MySQL</h2>
	<?php
	...
	<div class="row">
		<div class="col-sm-4" >
			<img class="product_image" src="image/<?php echo $item["image"]; ?>" style="width:300px;height:168px;padding-top:10px;">
		</div>
		<div class="col-sm-8">
	...
	<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="loginmodal-container">
				<h1>Login to rate this resturant</h1><br>
				...
				<div class="login-help">					
					<p><b>User</b> : Riya, Hasbulla, smith, merry <b>Password</b>: 123</p>
				</div>
			</div>
		</div>
	</div>
